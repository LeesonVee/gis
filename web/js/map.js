...
function htmlCode(pkey){
    let html='<!DOCTYPE html>'
        ...
        +'                                  <el-table-column label="操作"><template slot-scope="scope"><el-button @click="showClick(\'1\',scope.row)" type="text" size="small">显示</el-button><el-button @click="addFilterClick(scope.row,\'1\')" type="text" size="small">数据过滤</el-button></template></el-table-column>'
        +'                              </el-table>'
        +'                          </el-collapse-item>'
        ...
        +'                                  <el-table-column label="名称" width="220"><template slot-scope="scope">{{ scope.row.MODEL_RELATION_NAME }}</template></el-table-column>'
        +'                                  <el-table-column label="操作"><template slot-scope="scope"><el-button @click="showClick(\'2\',scope.row)" type="text" size="small">显示</el-button><el-button @click="addFilterClick(scope.row,\'2\')" type="text" size="small">数据过滤</el-button></template></el-table-column>'
        +'                              </el-table>'
        +'                          </el-collapse-item>'
        ...
        +'                                  <el-table-column label="名称" width="220"><template slot-scope="scope">{{ scope.row.MODEL_RELATION_NAME }}</template></el-table-column>'
        +'                                  <el-table-column label="操作"><template slot-scope="scope"><el-button @click="showClick(\'3\',scope.row)" type="text" size="small">显示</el-button><el-button @click="addFilterClick(scope.row,\'3\')" type="text" size="small">数据过滤</el-button></template></el-table-column>'
        +'                              </el-table>'
        +'                          </el-collapse-item>'
        ...
        +'                                  <el-table-column label="名称" width="220"><template slot-scope="scope">{{ scope.row.MODEL_RELATION_NAME }}</template></el-table-column>'
        +'                                  <el-table-column label="操作"><template slot-scope="scope"><el-button @click="showClick(\'4\',scope.row)" type="text" size="small">显示</el-button><el-button @click="addFilterClick(scope.row,\'4\')" type="text" size="small">数据过滤</el-button></template></el-table-column>'
        +'                              </el-table>'
        +'                          </el-collapse-item>'
        +'                      </el-collapse>'
        +'                  </div>'
